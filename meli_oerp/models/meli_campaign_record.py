...
class MeliCampaignRecordLine(models.Model):
    ...
    def action_publish_to_meli(self):
        ...
        for line in self:
            ...
            url = "/users/%s/deals/%s/proposed_items" % ('375328189', line.meli_campaign_id.campaign_id.meli_id)
    ...
    def action_unpublish_to_meli(self):
        ...
        for line in lines_unpublish:
            url = "/users/%s/deals/%s/proposed_items/%s" % ('375328189', line.meli_campaign_id.campaign_id.meli_id, line.product_template_id.meli_id)
